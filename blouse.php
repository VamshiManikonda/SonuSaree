<html>
	...
	$formCode = <<<HTML
			<form action="" method ="POST" enctype="multipart/form-data">
				<h2 align ="center">SHOES IMAGE UPLOAD PAGE</h2>
				<table align="center">
				<tr>
...
//var_dump($_SESSION);
	...
	if($con= mysqli_connect("localhost","root","","login")) {
				    ...
				    $q = mysqli_query($con, "SELECT id, path from blouse");
					...
					foreach ($images as $id=>$img) {
						...
						if(isset($_SESSION['is_admin']) && ($_SESSION['is_admin'] == true)) {
										echo "<a href='blouse_del.php?del=$id'><br/><button>Delete</button></a><br/><br/>";
									}
	    ...
	    if(isset($_POST['save_btn']))
		{
			if($con)
			{
				...
				$filepath= "blouses/".$filename;
				
				move_uploaded_file($filetmp, $filepath);
				$query = mysqli_query($con,"INSERT INTO blouse(name, path, type) VALUES('$filename','$filepath','$filetype')");
