<html>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">LEHENGAS</a>
            </div>
	...
	$formCode = <<<HTML
			<form action="" method ="POST" enctype="multipart/form-data">
				<h2 align ="center">LEHENGA IMAGE UPLOAD PAGE</h2>
				<table align="center">
				<tr>
...
//var_dump($_SESSION);
	...
	if($con= mysqli_connect("localhost","root","","login")) {
				    ...
				    $q = mysqli_query($con, "SELECT id, path from lehenga order by id desc");
					...
					foreach ($images as $id=>$img)
					{
						...
						if(isset($_SESSION['is_admin']) && ($_SESSION['is_admin'] == true)) 
						{
							echo "<table align=\"center\"><td><a href='lehenga_del.php?del=$id'><br/><button>Delete</button></a></td></table><br/><br/>";
						}
	    ...
	    if(isset($_POST['save_btn']))
		{
			if($con)
			{
				...
				$filepath= "lehenga/".$filename;
				
				move_uploaded_file($filetmp, $filepath);
				$query = mysqli_query($con,"INSERT INTO lehenga(name, path, type) VALUES('$filename','$filepath','$filetype')");
