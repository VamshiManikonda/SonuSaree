<html>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">BOYS WEAR</a>
            </div>
	...
	$formCode = <<<HTML
			<form action="" method ="POST" enctype="multipart/form-data">
				<h2 align ="center">BOYS WEAR IMAGE UPLOAD PAGE</h2>
				<table align="center">
				<tr>
...
//var_dump($_SESSION);
	...
	if($con= mysqli_connect("localhost","root","","login")) {
				    ...
				    $q = mysqli_query($con, "SELECT id, path from boys order by id desc");
					...
					{
						echo "<table align=\"center\"><td><img src='$img' width='600' class=\"img-responsive\" /></td></table><br/><br/>";
					

						if(isset($_SESSION['is_admin']) && ($_SESSION['is_admin'] == true)) 
						{
							echo "<table align=\"center\"><td><a href='boys_del.php?del=$id'><br/><button>Delete</button></a></td></table><br/><br/>";
						}
	    ...
	    if(isset($_POST['save_btn']))
		{
			if($con)
			{
				...
				$filepath= "boys/".$filename;
				
				move_uploaded_file($filetmp, $filepath);
				$query = mysqli_query($con,"INSERT INTO boys(name, path, type) VALUES('$filename','$filepath','$filetype')");
