...
//var_dump($_SESSION);
	...
	if($con= mysqli_connect("localhost","root","","login")) {
				    ...
				    $q = mysqli_query($con, "SELECT id, path from shoes");
					...
					foreach ($images as $id=>$img) {
						...
						if(isset($_SESSION['is_admin']) && ($_SESSION['is_admin'] == true)) {
										echo "<a href='shoes_del.php?del=$id'><br/><button>Delete</button></a><br/><br/>";
									}
	    ...
	    if(isset($_POST['save_btn']))
		{
			if($con)
			{
				...
				$filepath= "shoes/".$filename;
				
				move_uploaded_file($filetmp, $filepath);
				$query = mysqli_query($con,"INSERT INTO shoes(name, path, type) VALUES('$filename','$filepath','$filetype')");
