<html>
	...
	$formCode = <<<HTML
			<form action="" method ="POST" enctype="multipart/form-data">
				<h2 align ="center">DHUPHATAS IMAGE UPLOAD PAGE</h2>
				<table align="center">
				<tr>
...
//var_dump($_SESSION);
	...
	if($con= mysqli_connect("localhost","root","","login")) {
				    ...
				    $q = mysqli_query($con, "SELECT id, path from dhuphatas");
					...
					foreach ($images as $id=>$img) {
						...
						if(isset($_SESSION['is_admin']) && ($_SESSION['is_admin'] == true)) {
										echo "<a href='dhuphatas_del.php?del=$id'><br/><button>Delete</button></a><br/><br/>";
									}
	    ...
	    if(isset($_POST['save_btn']))
		{
			if($con)
			{
				...
				$filepath= "dhuphatas/".$filename;
				
				move_uploaded_file($filetmp, $filepath);
				$query = mysqli_query($con,"INSERT INTO dhuphatas(name, path, type) VALUES('$filename','$filepath','$filetype')");
