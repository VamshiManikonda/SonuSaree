<html>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">KURTHA PYJAMA</a>
            </div>
	...
	$formCode = <<<HTML
			<form action="" method ="POST" enctype="multipart/form-data">
				<h2 align ="center"> KURTHAPYJAMA IMAGE UPLOAD PAGE</h2>
				<table align="center">
				<tr>
	...
	<br/><table align="center"><td><a href="logout.php"><button>Logout</button></td></a></table><br/>
HTML;
...
//var_dump($_SESSION);
	...
	if($con= mysqli_connect("localhost","root","","login")) {
				    ...
				    $q = mysqli_query($con, "SELECT id, path from kurthapyjama order by id desc");
					...
					{
						echo " <br/><br/><table align=\"center\"><td><img src='$img' width='600' class=\"img-responsive\" /></td></table><br/>";
					

						if(isset($_SESSION['is_admin']) && ($_SESSION['is_admin'] == true)) {
										echo "<table align=\"center\"><td><a href='kurthapyjama_del.php?del=$id'><br/><button>Delete</button></a></td></table><br/><br/>";
									}
	    ...
	    if(isset($_POST['save_btn']))
		{
			if($con)
			{
				...
				$filepath= "kurthapyjama/".$filename;
				
				move_uploaded_file($filetmp, $filepath);
				$query = mysqli_query($con,"INSERT INTO kurthapyjama(name, path, type) VALUES('$filename','$filepath','$filetype')");
