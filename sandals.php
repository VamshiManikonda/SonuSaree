<html>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">SANDALS</a>
            </div>
	...
	$formCode = <<<HTML
			<form action="" method ="POST" enctype="multipart/form-data">
				<h2 align ="center">ACCESSORIES IMAGE UPLOAD PAGE</h2>
				<table align="center">
				<tr>
	...
	if($con= mysqli_connect("localhost","root","","login"))
		{
				    ...
				    $q = mysqli_query($con, "SELECT id, path from sandles order by id desc");
					...
					foreach ($images as $id=>$img) 
					{
						...
						if(isset($_SESSION['is_admin']) && ($_SESSION['is_admin'] == true)) 
						{
							echo "<table align=\"center\"><td><a href='sandles_del.php?del=$id'><br/><button>Delete</button></td></table></a><br/><br/>";
						}
	    ...
	    if(isset($_POST['save_btn']))
		{
			if($con)
			{
				...
				$filepath= "sandles/".$filename;
				
				move_uploaded_file($filetmp, $filepath);
				$query = mysqli_query($con,"INSERT INTO sandles(name, path, type) VALUES('$filename','$filepath','$filetype')");
